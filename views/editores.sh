...
showOptions() {
	...
	echo $green;
	echo "\t1 - Inkscape: software livre para editoração eletrônica de imagens e documentos vetoriais";
	echo "\t2 - LibreOfice: suíte de aplicativos livre para escritório";
...
chooseAction() {
	...
	case $opcao in 
		...
		1)
			./controllers/InkscapeInstall.sh;;
		2)
			./controllers/LibreOfficeInstall.sh;;
